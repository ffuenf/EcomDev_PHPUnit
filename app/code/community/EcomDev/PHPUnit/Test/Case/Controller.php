...
abstract class EcomDev_PHPUnit_Test_Case_Controller extends EcomDev_PHPUnit_Test_Case
{
     ...
     */
    public static function layoutBlockProperty($blockName, $propertyName, PHPUnit\Framework\Constraint $constraint)
    {
     ...
     * @param PHPUnit\Framework\Constraint|null $constraint
     * @return EcomDev_PHPUnit_Constraint_Controller_Response_Header
     */
    public static function responseHeader($headerName, $type, PHPUnit\Framework\Constraint $constraint = null)
    {
     ...
     */
    public static function responseBody(PHPUnit\Framework\Constraint $constraint)
    {
     ...
     * @param string $message
     */
    public static function assertThatResponse(PHPUnit\Framework\Constraint $constraint, $message)
    {
     ...
     * @param string $message
     */
    public static function assertResponseHeader($headerName, PHPUnit\Framework\Constraint $constraint, $message = '')
    {
        self::assertThatResponse(
            self::responseHeader(
                $headerName,
     ...
     * @param string $message
     */
    public static function assertResponseHeaderNot($headerName, PHPUnit\Framework\Constraint $constraint, $message = '')
    {
        self::assertThatResponse(
            self::responseHeader(
                $headerName,
     ...
     * @param string $message
     */
    public static function assertResponseBody(PHPUnit\Framework\Constraint $constraint, $message = '')
    {
        self::assertThatResponse(
     ...
     * @param string $message
     */
    public static function assertResponseBodyNot(PHPUnit\Framework\Constraint $constraint, $message = '')
    {
        self::assertThatResponse(
            self::logicalNot(
                self::responseBody($constraint)
     ...
     * @param PHPUnit\Framework\Constraint $constraint
     * @param string $message
     * @internal param \EcomDev_PHPUnit_Constraint_AbstractLayout|\PHPUnit\Framework\Constraint $constaint
     */
    public static function assertThatLayout(PHPUnit\Framework\Constraint $constraint, $message)
    {
    ...
    public static function assertLayoutBlockRenderedContent($blockName,
        PHPUnit\Framework\Constraint $constraint, $message = '')
    {
        self::assertThatLayout(
            self::layoutBlock(
                $blockName,
    ...
    public static function assertLayoutBlockAfterAll($blockName, array $after, $message = '')
    {
        ...
        $logicalAnd = new PHPUnit\Framework\Constraint_And();
