    ...
    extends EcomDev_PHPUnit_Constraint_Controller_AbstractResponse
{
     ...
     * @param string $type
     */
    public function __construct(PHPUnit\Framework\Constraint $constraint = null, $type = self::TYPE_CONSTRAINT)
    {
        $this->_expectedValueValidation += array(
            self::TYPE_CONSTRAINT => array(true, null, 'PHPUnit\Framework\Constraint')
        );
